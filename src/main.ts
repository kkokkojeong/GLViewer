...
const e: Ellipsoid = new Ellipsoid({
  radii: vec3.fromValues(1.0, 1.0, 1.0)
});
const el: Geometry = e.createGeometry();

const ellipsoid: Geometry = new Geometry();
...
const wireframeGeometry: WireframeGeometry = new WireframeGeometry(ellipsoid);
